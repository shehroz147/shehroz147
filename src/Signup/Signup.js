...
export default function Signup({ navigation }) {
  ...
  const subCategoryList = [
    { label: "Installation Technition", value: "Installation Technition" },
    { label: "Car Electrition", value: "Car Electrition" },
    { label: "Appliances", value: "Appliances" },
    { label: "Bike Mechanic", value: "Bike Mechanic" },
    { label: "Generator Mechanic", value: "Generator Mechanic" },
     ...
     source={require('../../assets/SignUpBg.png')}
      ...
      <View style={{justifyContent:'center',alignItems:'center',marginTop:90}}>
          ...
          >
           ...
           <View  style={{ width: "75%",height:60,borderRadius:5,marginTop:10}}>
                <RNPickerSelect
                placeholder={{'label':'Select Your Service'}} 
        ...
        />
                ...
                >
                 ...
                 <Button
                  ...
                  type="submit"
                >
                 <Text style ={{textAlign:'center',color:'white',fontSize:22}}> Register ! </Text>
                </Button>
              </>
            )}
          </Formik>
